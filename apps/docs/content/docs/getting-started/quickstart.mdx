...
<Callout type="info">
  **Prerequisites**: Make sure you have Node.js 18+ (22+ recommended), pnpm 10.11+, and AWS credentials configured. See [Prerequisites](/docs/getting-started/prerequisites) for detailed setup.
</Callout>
...
<Callout>
  You've deployed your first application. Here's what to explore next:
</Callout>

- Learn about [Architecture](/docs/getting-started/architecture)
