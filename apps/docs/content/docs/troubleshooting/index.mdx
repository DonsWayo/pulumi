...
### Build Issues
- [ ] Node.js version is 18+ (22+ recommended)
...
{
  "dependencies": {
    "xyz": "^1.0.0"  // ✅ Will be included
  },
  "devDependencies": {
    "abc": "^1.0.0"  // ❌ Won't be included
  }
}
```
...
- 📚 [Documentation](/docs)
- 💬 [GitHub Discussions](https://github.com/donswayo/pulu-front/discussions)
- 🐛 [Issue Tracker](https://github.com/donswayo/pulu-front/issues)
...
<Cards>
  <Card
    title="FAQ"
    href="/docs/troubleshooting/faq"
    description="More questions and answers"
  />
  <Card
    title="Configuration"
    href="/docs/configuration"
  ...
  <Card
    title="GitHub Issues"
    href="https://github.com/donswayo/pulu-front/issues"
